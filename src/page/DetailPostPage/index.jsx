...
const DetailPostPage = () => {
  ...
  return (
    <main className="max-w-2xl mx-auto my-20 overflow-hidden rounded-lg shadow-lg bg-gray-20 opacity-95">
      <Navbar />
      <div className="flex items-center justify-between p-4 ">
        <div className="flex items-center">
          {isPostOwner ? (
            <button
              className="flex items-center text-2xl font-medium text-black rounded-lg hover:bg-white focus:ring-2 focus:ring-gray-300 focus:outline-none"
        ...
        {isPostOwner && (
          <div className="flex space-x-2">
            <button
              className="px-2 py-1 text-sm text-white bg-gray-400 rounded hover:bg-blue-600"
      ...
      <div className="flex items-center justify-between p-4">
        <div className="flex items-center">
          <img
            className="object-cover w-10 h-10 border-2 border-red-600 rounded-full"
      ...
      <div className="p-4">
          ...
          {post.isLike ? (
            <FaHeart
              className={`text-2xl cursor-pointer ${
                isLiking ? "text-gray-400" : "text-red-500"
              }`}
            ...
            <FaRegHeart
              className={`text-2xl cursor-pointer ${
                isLiking ? "text-gray-400" : "text-gray-600"
              }`}
              onClick={handleToggleLike}
            />
          )}
        ...
        <div className="mt-4">
          ...
          ></textarea>
          <button
            className="px-4 py-2 mt-2 text-white bg-blue-600 rounded-md"
